...
| eBay | OAuth | yes | unknown | [`shopping/ebay`](../apis/shopping/ebay.json) |
| Etsy | OAuth | yes | unknown | [`shopping/etsy`](../apis/shopping/etsy.json) |
| Flipkart Marketplace | OAuth | yes | yes | [`shopping/flipkart-marketplace`](../apis/shopping/flipkart-marketplace.json) |
| Lazada | apiKey | yes | unknown | [`shopping/lazada`](../apis/shopping/lazada.json) |
| Marketplace Fee Data | No | yes | yes | [`shopping/marketplace-fee-data`](../apis/shopping/marketplace-fee-data.json) |
...
| OpenTiendas | apiKey | yes | unknown | [`shopping/opentiendas`](../apis/shopping/opentiendas.json) |
...
| Tokopedia | OAuth | yes | unknown | [`shopping/tokopedia`](../apis/shopping/tokopedia.json) |
| WooCommerce | apiKey | yes | yes | [`shopping/woocommerce`](../apis/shopping/woocommerce.json) |
