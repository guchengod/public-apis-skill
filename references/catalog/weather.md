...
43 interfaces. Paths are relative to this catalog file.

| API | Auth | HTTPS | CORS | Interface |
|---|---|---|---|---|
| Weatherstack | apiKey | yes | unknown | [`weather/weatherstack`](../apis/weather/weatherstack.json) |
| 7Timer! | No | no | unknown | [`weather/7timer`](../apis/weather/7timer.json) |
| AccuWeather | apiKey | no | unknown | [`weather/accuweather`](../apis/weather/accuweather.json) |
| Aemet | apiKey | yes | unknown | [`weather/aemet`](../apis/weather/aemet.json) |
| APIXU | apiKey | yes | unknown | [`weather/apixu`](../apis/weather/apixu.json) |
| AQICN | apiKey | yes | unknown | [`weather/aqicn`](../apis/weather/aqicn.json) |
| AviationWeather | No | yes | unknown | [`weather/aviationweather`](../apis/weather/aviationweather.json) |
| ColorfulClouds | apiKey | yes | yes | [`weather/colorfulclouds`](../apis/weather/colorfulclouds.json) |
| Euskalmet | apiKey | yes | unknown | [`weather/euskalmet`](../apis/weather/euskalmet.json) |
| Foreca | OAuth | yes | unknown | [`weather/foreca`](../apis/weather/foreca.json) |
| Hail History | No | yes | yes | [`weather/hail-history`](../apis/weather/hail-history.json) |
...
| NASA POWER | No | yes | yes | [`weather/nasa-power`](../apis/weather/nasa-power.json) |
...
| Pirate Weather | No | yes | yes | [`weather/pirate-weather`](../apis/weather/pirate-weather.json) |
| QWeather | apiKey | yes | yes | [`weather/qweather`](../apis/weather/qweather.json) |
| Rainbow Weather | apiKey | yes | unknown | [`weather/rainbow-weather`](../apis/weather/rainbow-weather.json) |
| RainViewer | No | yes | unknown | [`weather/rainviewer`](../apis/weather/rainviewer.json) |
| Storm Glass | apiKey | yes | yes | [`weather/storm-glass`](../apis/weather/storm-glass.json) |
| Terrace Weather | No | yes | yes | [`weather/terrace-weather`](../apis/weather/terrace-weather.json) |
| Tomorrow | apiKey | yes | unknown | [`weather/tomorrow`](../apis/weather/tomorrow.json) |
| US Weather | No | yes | yes | [`weather/us-weather`](../apis/weather/us-weather.json) |
| Visual Crossing | apiKey | yes | yes | [`weather/visual-crossing`](../apis/weather/visual-crossing.json) |
