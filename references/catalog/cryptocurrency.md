...
| Bitcambio | No | yes | unknown | [`cryptocurrency/bitcambio`](../apis/cryptocurrency/bitcambio.json) |
| BitcoinAverage | apiKey | yes | unknown | [`cryptocurrency/bitcoinaverage`](../apis/cryptocurrency/bitcoinaverage.json) |
| BitcoinCharts | No | yes | unknown | [`cryptocurrency/bitcoincharts`](../apis/cryptocurrency/bitcoincharts.json) |
| Bitcoin Halving | No | yes | yes | [`cryptocurrency/bitcoin-halving`](../apis/cryptocurrency/bitcoin-halving.json) |
| Bitfinex | apiKey | yes | unknown | [`cryptocurrency/bitfinex`](../apis/cryptocurrency/bitfinex.json) |
| BitPanda | apiKey | yes | unknown | [`cryptocurrency/bitpanda`](../apis/cryptocurrency/bitpanda.json) |
| Bitmex | apiKey | yes | unknown | [`cryptocurrency/bitmex`](../apis/cryptocurrency/bitmex.json) |
| Bittrex | apiKey | yes | unknown | [`cryptocurrency/bittrex`](../apis/cryptocurrency/bittrex.json) |
| Block | apiKey | yes | unknown | [`cryptocurrency/block`](../apis/cryptocurrency/block.json) |
| BlazePhoenix | No | yes | yes | [`cryptocurrency/blazephoenix`](../apis/cryptocurrency/blazephoenix.json) |
| Block Lottos | No | yes | yes | [`cryptocurrency/block-lottos`](../apis/cryptocurrency/block-lottos.json) |
...
| CoinAPI | apiKey | yes | no | [`cryptocurrency/coinapi`](../apis/cryptocurrency/coinapi.json) |
| Coinbase | apiKey | yes | unknown | [`cryptocurrency/coinbase`](../apis/cryptocurrency/coinbase.json) |
| Coinbase Pro | apiKey | yes | unknown | [`cryptocurrency/coinbase-pro`](../apis/cryptocurrency/coinbase-pro.json) |
| CoinCap | No | yes | unknown | [`cryptocurrency/coincap`](../apis/cryptocurrency/coincap.json) |
| CoinDCX | apiKey | yes | unknown | [`cryptocurrency/coindcx`](../apis/cryptocurrency/coindcx.json) |
| CoinDesk | No | yes | unknown | [`cryptocurrency/coindesk`](../apis/cryptocurrency/coindesk.json) |
| CoinGecko | No | yes | yes | [`cryptocurrency/coingecko`](../apis/cryptocurrency/coingecko.json) |
| Coinigy | apiKey | yes | unknown | [`cryptocurrency/coinigy`](../apis/cryptocurrency/coinigy.json) |
| Coinlib | apiKey | yes | unknown | [`cryptocurrency/coinlib`](../apis/cryptocurrency/coinlib.json) |
...
| FraudCoins | No | yes | yes | [`cryptocurrency/fraudcoins`](../apis/cryptocurrency/fraudcoins.json) |
...
| Indodax | apiKey | yes | unknown | [`cryptocurrency/indodax`](../apis/cryptocurrency/indodax.json) |
| INFURA Ethereum | apiKey | yes | yes | [`cryptocurrency/infura-ethereum`](../apis/cryptocurrency/infura-ethereum.json) |
| Kraken | apiKey | yes | unknown | [`cryptocurrency/kraken`](../apis/cryptocurrency/kraken.json) |
| KuCoin | apiKey | yes | unknown | [`cryptocurrency/kucoin`](../apis/cryptocurrency/kucoin.json) |
| Localbitcoins | No | yes | unknown | [`cryptocurrency/localbitcoins`](../apis/cryptocurrency/localbitcoins.json) |
| MadeOnSol | apiKey | yes | yes | [`cryptocurrency/madeonsol`](../apis/cryptocurrency/madeonsol.json) |
| Mempool | No | yes | no | [`cryptocurrency/mempool`](../apis/cryptocurrency/mempool.json) |
| MercadoBitcoin | No | yes | unknown | [`cryptocurrency/mercadobitcoin`](../apis/cryptocurrency/mercadobitcoin.json) |
| Messari | No | yes | unknown | [`cryptocurrency/messari`](../apis/cryptocurrency/messari.json) |
| Mexc | apiKey | yes | unknown | [`cryptocurrency/mexc`](../apis/cryptocurrency/mexc.json) |
| monerometrics | No | yes | yes | [`cryptocurrency/monerometrics`](../apis/cryptocurrency/monerometrics.json) |
| Nexchange | No | no | yes | [`cryptocurrency/nexchange`](../apis/cryptocurrency/nexchange.json) |
| Nomics | apiKey | yes | yes | [`cryptocurrency/nomics`](../apis/cryptocurrency/nomics.json) |
| NovaDax | apiKey | yes | unknown | [`cryptocurrency/novadax`](../apis/cryptocurrency/novadax.json) |
| OKEx | apiKey | yes | unknown | [`cryptocurrency/okex`](../apis/cryptocurrency/okex.json) |
...
| WorldCoinIndex | apiKey | yes | unknown | [`cryptocurrency/worldcoinindex`](../apis/cryptocurrency/worldcoinindex.json) |
| Zennet | No | yes | yes | [`cryptocurrency/zennet`](../apis/cryptocurrency/zennet.json) |
| ZMOK | No | yes | unknown | [`cryptocurrency/zmok`](../apis/cryptocurrency/zmok.json) |
