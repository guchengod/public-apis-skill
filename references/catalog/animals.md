...
| Dogs | No | yes | yes | [`animals/dogs`](../apis/animals/dogs.json) |
| eBird | apiKey | yes | no | [`animals/ebird`](../apis/animals/ebird.json) |
...
| RandomDuck | No | yes | no | [`animals/randomduck`](../apis/animals/randomduck.json) |
| RandomFox | No | yes | no | [`animals/randomfox`](../apis/animals/randomfox.json) |
| RescueGroups | No | yes | unknown | [`animals/rescuegroups`](../apis/animals/rescuegroups.json) |
| Shibe.Online | No | yes | yes | [`animals/shibe-online`](../apis/animals/shibe-online.json) |
| The Dog | apiKey | yes | no | [`animals/the-dog`](../apis/animals/the-dog.json) |
| xeno-canto | No | yes | unknown | [`animals/xeno-canto`](../apis/animals/xeno-canto.json) |
