...
|---|---|---|---|---|
| Bitquery | apiKey | yes | yes | [`blockchain/bitquery`](../apis/blockchain/bitquery.json) |
| Blockscout | apiKey | yes | no | [`blockchain/blockscout`](../apis/blockchain/blockscout.json) |
| Chainlink | No | yes | unknown | [`blockchain/chainlink`](../apis/blockchain/chainlink.json) |
...
| Watchdata | apiKey | yes | unknown | [`blockchain/watchdata`](../apis/blockchain/watchdata.json) |
