...
| markerapi | No | no | unknown | [`business/markerapi`](../apis/business/markerapi.json) |
| Meirra | apiKey | yes | yes | [`business/meirra`](../apis/business/meirra.json) |
| ORB Intelligence | apiKey | yes | unknown | [`business/orb-intelligence`](../apis/business/orb-intelligence.json) |
| Pick an Agency | No | yes | yes | [`business/pick-an-agency`](../apis/business/pick-an-agency.json) |
| Redash | apiKey | yes | yes | [`business/redash`](../apis/business/redash.json) |
| Signaliz | apiKey | yes | unknown | [`business/signaliz`](../apis/business/signaliz.json) |
| Smartsheet | OAuth | yes | no | [`business/smartsheet`](../apis/business/smartsheet.json) |
| Square | OAuth | yes | unknown | [`business/square`](../apis/business/square.json) |
| SwiftKanban | apiKey | yes | unknown | [`business/swiftkanban`](../apis/business/swiftkanban.json) |
| Tenders in Hungary | No | yes | unknown | [`business/tenders-in-hungary`](../apis/business/tenders-in-hungary.json) |
| Tenders in Poland | No | yes | unknown | [`business/tenders-in-poland`](../apis/business/tenders-in-poland.json) |
