...
72 interfaces. Paths are relative to this catalog file.

| API | Auth | HTTPS | CORS | Interface |
|---|---|---|---|---|
| Marketstack | apiKey | yes | unknown | [`finance/marketstack`](../apis/finance/marketstack.json) |
| Aletheia | apiKey | yes | yes | [`finance/aletheia`](../apis/finance/aletheia.json) |
| Alpaca | apiKey | yes | yes | [`finance/alpaca`](../apis/finance/alpaca.json) |
...
| BriefTape | apiKey | yes | yes | [`finance/brieftape`](../apis/finance/brieftape.json) |
...
| SEC EDGAR Data | No | yes | yes | [`finance/sec-edgar-data`](../apis/finance/sec-edgar-data.json) |
| SmartAPI | apiKey | yes | unknown | [`finance/smartapi`](../apis/finance/smartapi.json) |
| StockData | apiKey | yes | yes | [`finance/stockdata`](../apis/finance/stockdata.json) |
...
| Zoho Books | OAuth | yes | unknown | [`finance/zoho-books`](../apis/finance/zoho-books.json) |
