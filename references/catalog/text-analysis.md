...
| Google Cloud Natural | apiKey | yes | unknown | [`text-analysis/google-cloud-natural`](../apis/text-analysis/google-cloud-natural.json) |
| GeoScore | apiKey | yes | yes | [`text-analysis/geoscore`](../apis/text-analysis/geoscore.json) |
| Hirak OCR | apiKey | yes | unknown | [`text-analysis/hirak-ocr`](../apis/text-analysis/hirak-ocr.json) |
| Hirak Translation | apiKey | yes | unknown | [`text-analysis/hirak-translation`](../apis/text-analysis/hirak-translation.json) |
| Kiprio Translate | apiKey | yes | yes | [`text-analysis/kiprio-translate`](../apis/text-analysis/kiprio-translate.json) |
| Langbly | apiKey | yes | yes | [`text-analysis/langbly`](../apis/text-analysis/langbly.json) |
| Lecto Translation | apiKey | yes | yes | [`text-analysis/lecto-translation`](../apis/text-analysis/lecto-translation.json) |
| LibreTranslate | No | yes | unknown | [`text-analysis/libretranslate`](../apis/text-analysis/libretranslate.json) |
