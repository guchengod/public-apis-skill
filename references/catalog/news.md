...
|---|---|---|---|---|
| Mediastack | apiKey | yes | unknown | [`news/mediastack`](../apis/news/mediastack.json) |
...
| GNews | apiKey | yes | yes | [`news/gnews`](../apis/news/gnews.json) |
| Graphs for Coronavirus | No | yes | yes | [`news/graphs-for-coronavirus`](../apis/news/graphs-for-coronavirus.json) |
| Inshorts News | No | yes | unknown | [`news/inshorts-news`](../apis/news/inshorts-news.json) |
| MarketAux | apiKey | yes | yes | [`news/marketaux`](../apis/news/marketaux.json) |
| New York Times | apiKey | yes | unknown | [`news/new-york-times`](../apis/news/new-york-times.json) |
...
| Spaceflight News | No | yes | yes | [`news/spaceflight-news`](../apis/news/spaceflight-news.json) |
| The Guardian | apiKey | yes | unknown | [`news/the-guardian`](../apis/news/the-guardian.json) |
| The Old Reader | apiKey | yes | unknown | [`news/the-old-reader`](../apis/news/the-old-reader.json) |
| TheNews | apiKey | yes | yes | [`news/thenews`](../apis/news/thenews.json) |
| Trove | apiKey | yes | unknown | [`news/trove`](../apis/news/trove.json) |
