...
| Kelley Blue Book | apiKey | yes | no | [`vehicle/kelley-blue-book`](../apis/vehicle/kelley-blue-book.json) |
| Mercedes-Benz | apiKey | yes | no | [`vehicle/mercedes-benz`](../apis/vehicle/mercedes-benz.json) |
| NHTSA | No | yes | unknown | [`vehicle/nhtsa`](../apis/vehicle/nhtsa.json) |
